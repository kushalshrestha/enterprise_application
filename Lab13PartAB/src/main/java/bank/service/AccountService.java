...
public class AccountService implements IAccountService {
	...
	public AccountDTO createAccount(long accountNumber, String customerName) {
		...
		logger.log("Account instance created", "INFO");
		Customer customer = new Customer(customerName);
		logger.log("Customer instance created", "INFO");
		account.setCustomer(customer);
		accountDAO.save(account);
		logger.log("AccountDAO save", "INFO");
	...
	public void deposit(long accountNumber, double amount) {
		...
		if (amount > 10000) {
			...
			logger.log("AccountNumber : " + accountNumber, "DEBUG");
			logger.log("AMOUNT : " + amount, "DEBUG");
		}
	}
	...
	public void withdraw(long accountNumber, double amount) {
		...
		accountDAO.save(account);
		publisher.publishEvent(new AccountChangeEvent("withdraw", accountNumber, amount));
		logger.log("Withdrawn from account. See the amount after deduction", "INFO");
	...
	public void transferFunds(long fromAccountNumber, long toAccountNumber,
		...
		if (amount > 10000) {
			logger.log("Greater than 10000 transferred. Verify on both the account", "WARN");
